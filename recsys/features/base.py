...
def build_blocks(cfg: Dict, profile: Dict) -> Dict[str, FeatureBlock]:
    ...
    This helper merges the base feature config with profile-level overrides,
    applies ``enabled`` gates, and returns instantiated blocks in declaration
    order to make deterministic outputs.
    """
